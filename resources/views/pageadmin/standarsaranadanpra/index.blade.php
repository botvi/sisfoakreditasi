...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            $fileExtension = pathinfo($StandarSaranaDanPra->file_path, PATHINFO_EXTENSION);
            ...
            <div class="card h-100" style="background-color: {{ $bgColor }}; color: #fff;">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <div class=" flex-grow-1">
                                ...
                                <h6 class="card-text text-white">Waktu Upload: {{ \Carbon\Carbon::parse($StandarSaranaDanPra->created_at)->format('d F Y') }}</h6>
